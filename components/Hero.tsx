...
export default function Hero() {
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-[1400px] mx-auto px-6 md:px-10 pb-20 flex flex-col gap-6" style={{ zIndex: 1 }}>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1.5 pointer-events-none" style={{ zIndex: 1 }}>
